...
export default async function AdminPage(){
  ...
  return <AppShell><main className="container"><div className="page-head"><div><h1>Painel administrativo</h1><p>Gerencie livros, envios dos usuários, usuários, categorias e integrações.</p></div><div className="row wrap"><Link className="btn secondary" href="/admin/conhecimento">Conhecimento</Link><Link className="btn" href="/admin/assinaturas">Assinaturas e Telegram</Link></div></div><div className="notice" style={{marginBottom:16}}>Os envios chegam com o <b>EPUB original</b>. Para publicar no acervo, anexe manualmente o <b>PDF de leitura</b> correspondente antes de aprovar.</div><AdminDashboard initialBooks={(books||[]) as Book[]} initialCategories={(categories||[]) as Category[]} initialProfiles={(profiles||[]) as Profile[]} initialUserBooks={uploads}/></main></AppShell>;
}
