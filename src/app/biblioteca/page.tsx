  ...
  return <AppShell><main className="library-home">
    ...
    <div className="shell-width library-content" id="acervo">
      ...
      <section className="library-section catalog-section">
        <div className="section-heading"><div><span className="eyebrow">ACERVO</span><h2>Biblioteca</h2><p>Livros publicados e organizados por categoria.</p></div><span className="collection-count">{query?base.length:totalBooks} livro{(query?base.length:totalBooks)===1?"":"s"}</span></div>
